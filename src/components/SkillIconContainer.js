...
const { theme } = useContext(GlobalContext);
  return (
    ...
    <div className={`overflow-hidden group bg-lightBg box2 rounded-3xl gap-4 `} >
        ...
        <div className={`flex px-3 rounded-3xl py-4 flex-col items-center font-semibold justify-center h-[80px] w-auto transition-transform ${theme==='light'?'text-lightTheme bg-lightBg ':'text-darkTheme bg-darkBg'} translate-y-10  group-hover:-translate-y-20 `}>
          {name}
        </div>
